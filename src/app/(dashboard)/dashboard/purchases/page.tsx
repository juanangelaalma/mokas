...
export default function PurchasesPage() {
  ...
  const fetchPurchases = async (page = 1) => {
    setLoading(true);
    try {
      const res = await fetch(`/api/purchases?page=${page}&pageSize=20`);
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-10 text-gray-500">
              Belum ada pembelian.{' '}
              <Link href="/dashboard/purchases/new" className="text-primary-600 hover:underline">
            ...
            <>
                ...
                <TableBody>
                  {purchases.map((purchase) => (
                    <TableRow key={purchase.id}>
                      ...
                      <TableCell>
                        <Link href={`/dashboard/purchases/${purchase.id}`} className="text-primary-600 hover:underline font-mono">
              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t">
                <p className="text-sm text-gray-500">
                  Menampilkan {purchases.length} dari {pagination.total} pembelian
                </p>
